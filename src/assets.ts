...
import riftwalkerWhaleImage from "./assets/riftwalker-whale.webp";
...
import gravityWhalePassImage from "./assets/gravity-whale-pass.png";
import gravityWhaleBeamImage from "./assets/gravity-whale-beam.png";
...
export const RIFTWALKER_WHALE_IMAGE = riftwalkerWhaleImage;
...
export const GRAVITY_WHALE_PASS_IMAGE = gravityWhalePassImage;
export const GRAVITY_WHALE_BEAM_IMAGE = gravityWhaleBeamImage;
