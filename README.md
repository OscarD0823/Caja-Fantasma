...
- Sincronización bidireccional PC–Android sin Firebase ni nube personal: con ambas aplicaciones abiertas en una red local o mediante USB tethering, Windows muestra una IP y un código de seis números para intercambiar puntos, cajas, rondas, personajes, historial y módulos Brillantes. El programa rechaza direcciones públicas y nunca copia el modo administrador ni los ajustes propios de la ventana.
