...
- Contador flotante movible, siempre visible, escalable entre 20 % y 150 % y con posición recordada. El área transparente de la Ballena y futuros adicionales usa una escala independiente de 20 % a 100 %; al reducirla disminuyen tanto la animación como su espacio reservado. Puede usar la forma automática propia de cada evento o un diseño rectangular, cuadrado, vertical o redondo. El reloj admite lectura digital, compacta o mediante anillo de progreso, y el nombre se puede mostrar en español, inglés o con un texto personalizado local. La X lo desactiva y los controles del inicio permiten recuperarlo y cambiar ambos tamaños. Funciona sobre juegos en ventana o pantalla completa sin bordes; Windows no permite garantizar superposición sobre pantalla completa exclusiva.
